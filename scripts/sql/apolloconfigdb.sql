...
CREATE TABLE `AuditLog` (
  `Id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `TraceId` varchar(128) NOT NULL DEFAULT '' COMMENT '链路全局唯一ID',
  `SpanId` varchar(128) NOT NULL DEFAULT '' COMMENT '跨度ID',
  `ParentSpanId` varchar(128) NOT NULL DEFAULT '' COMMENT '父跨度ID',
  `FollowsFromSpanId` varchar(128) NOT NULL DEFAULT '' COMMENT '上一个兄弟跨度ID',
  ...
  `SourceHost` varchar(50) NOT NULL DEFAULT 'default' COMMENT '来源主机名',
  `CurrentHost` varchar(50) NOT NULL DEFAULT 'default' COMMENT '当前主机名',
  `IsDeleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '1: deleted, 0: normal',
  `DeletedAt` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'Delete timestamp based on milliseconds',
  `DataChange_CreatedBy` varchar(64) NOT NULL DEFAULT 'default' COMMENT '创建人邮箱前缀',
  `DataChange_CreatedTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `AuditLogDataInfluence` (
  ...
  `FieldName` varchar(50) NOT NULL DEFAULT 'default' COMMENT '字段名称',
