...
public class ConfigServiceTest extends AbstractUnitTest {
  ...
  @Mock private AdminServiceAPI.ReleaseAPI releaseAPI;
  @Mock private AdminServiceAPI.ItemAPI itemAPI;
  @Mock private PropertyResolver resolver;
  @Mock private UserInfoHolder userInfoHolder;

  @InjectMocks private ItemService configService;
  ...
  private NamespaceDTO generateNamespaceDTO(
  ...
  private List<NamespaceIdentifier> generateNamespaceIdentifier(
