...
public class UserIdentityContextHolderTest {
    ...
    public void getAuthType_WhenNotSet_ShouldReturnNull() {
        ...
        assertNull(UserIdentityContextHolder.getAuthType(), "Expected null when AUTH_TYPE_HOLDER is not set");
    }
    ...
    public void getAuthType_WhenSet_ShouldReturnCorrectValue() {
        ...
        assertEquals("TestAuthType", UserIdentityContextHolder.getAuthType(), "Expected 'TestAuthType' when AUTH_TYPE_HOLDER is set");
    }
    ...
    public void clear_ShouldRemoveAuthTypeHolderValue() {
        ...
        assertNull(UserIdentityContextHolder.getAuthType()); // Directly verify getAuthType() returns null
    }
}