...
public class CommitController {
  ...
  public CommitController(
      final CommitService commitService, final PermissionValidator permissionValidator) {
  ...
  public List<CommitDTO> find(
    ...
    if (StringUtils.isEmpty(key)) {
      ...
      return commitService.findByKey(
          appId, Env.valueOf(env), clusterName, namespaceName, key, page, size);
    }
  }
}
