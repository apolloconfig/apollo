...
public class KeyValueUtils {
   ...
   */
  public static Map<String, String> filterWithKeyIgnoreCaseEndsWith(
      Properties properties, String suffix) {
   ...
   */
  public static Map<String, String> filterWithKeyIgnoreCaseEndsWith(
      Map<String, String> keyValues, String suffix) {
    // use O(n) algorithm
   ...
   * @return
   */
  public static Map<String, String> removeKeySuffix(
      Map<String, String> keyValues, int suffixLength) {
    // use O(n) algorithm
    Map<String, String> map = new HashMap<>();
    for (Map.Entry<String, String> entry : keyValues.entrySet()) {
      String key = entry.getKey();
