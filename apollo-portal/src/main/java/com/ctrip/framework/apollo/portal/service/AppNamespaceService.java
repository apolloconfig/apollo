...
public class AppNamespaceService {
  ...
  @Transactional
  public AppNamespace createAppNamespaceInLocal(
      AppNamespace appNamespace, boolean appendNamespacePrefix) {
    ...
    appNamespaceName
        ...
        .append(
            appNamespace.formatAsEnum() == ConfigFileFormat.Properties
                ? ""
    ...
    roleInitializationService.initNamespaceRoles(
        appNamespace.getAppId(), appNamespace.getName(), operator);
    ...
    if (!CollectionUtils.isEmpty(privateAppNamespaces)) {
      ...
      throw new BadRequestException(
          "Public AppNamespace "
              ...
              + APP_NAMESPACE_JOINER.join(appIds)
  ...
  private void checkPublicAppNamespaceGlobalUniqueness(AppNamespace appNamespace) {
    ...
    if (publicAppNamespace != null) {
      throw new BadRequestException(
          "AppNamespace "
              + appNamespace.getName()
              + " already exists as public namespace in appId: "
