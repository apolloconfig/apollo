...
public class ConfigsExportService {
  ...
  public ConfigsExportService(AppService appService, ClusterService clusterService,
      ...
      PortalSettings portalSettings, UserPermissionValidator userPermissionValidator) {
   ...
   *
   * <p>
   * List<AppNamespaceMetadata> List<ownerName> -> List<App> -> List<Env> -> List<Namespace>
   * -----------------> app.metadata ------------------------------------------->
