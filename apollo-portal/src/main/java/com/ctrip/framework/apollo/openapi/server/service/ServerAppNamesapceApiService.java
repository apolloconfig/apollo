...
import com.ctrip.framework.apollo.openapi.api.AppNamespaceOpenApiService;
...
@Service
public class ServerAppNamesapceApiService implements AppNamespaceOpenApiService{

    private final AppNamespaceService appNamespaceService;
    private final UserInfoHolder userInfoHolder;
    private final ApplicationEventPublisher publisher;

    public ServerAppNamesapceApiService(
