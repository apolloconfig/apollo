...
public class NamespaceBranchController {
  ...
  public NamespaceBranchController(final UserPermissionValidator userPermissionValidator,
  ...
  @PreAuthorize(
      value = "@userPermissionValidator.hasModifyNamespacePermission(#appId, #env, #clusterName, #namespaceName)")
  @PostMapping(
  ...
  public void deleteBranch(@PathVariable String appId, @PathVariable String env,
    ...
    boolean hasModifyPermission = userPermissionValidator.hasModifyNamespacePermission(appId, env,
        clusterName, namespaceName);
    boolean hasReleasePermission = userPermissionValidator.hasReleaseNamespacePermission(appId, env,
        clusterName, namespaceName);
  ...
  @PreAuthorize(
      value = "@userPermissionValidator.hasOperateNamespacePermission(#appId, #env, #clusterName, #namespaceName)")
  @PutMapping(
      value = "/apps/{appId}/envs/{env}/clusters/{clusterName}/namespaces/{namespaceName}/branches/{branchName}/rules")
