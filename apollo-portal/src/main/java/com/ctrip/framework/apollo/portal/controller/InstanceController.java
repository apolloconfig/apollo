...
public class InstanceController {
  ...
  public PageDTO<InstanceDTO> getByNamespace(
    ...
    return instanceService.getByNamespace(
        Env.valueOf(env), appId, clusterName, namespaceName, instanceAppId, page, size);
  }

  @GetMapping("/envs/{env}/instances/by-namespace/count")
  public ResponseEntity<Number> getInstanceCountByNamespace(
      @PathVariable String env,
      @RequestParam String appId,
      @RequestParam String clusterName,
      @RequestParam String namespaceName) {
    ...
    int count =
        instanceService.getInstanceCountByNamespace(
            appId, Env.valueOf(env), clusterName, namespaceName);
  ...
  public List<InstanceDTO> getByReleasesNotIn(
    ...
    return instanceService.getByReleasesNotIn(
        Env.valueOf(env), appId, clusterName, namespaceName, releaseIdSet);
  }
}
