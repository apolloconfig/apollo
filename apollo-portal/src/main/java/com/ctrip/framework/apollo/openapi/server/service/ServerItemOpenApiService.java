...
/**
 * Legacy server-side Item OpenAPI service kept for compatibility.
 * Content mirrors PR03 baseline, only adds named Service to avoid bean conflicts.
 */
@Service("ServerItemOpenApiServiceOld")
