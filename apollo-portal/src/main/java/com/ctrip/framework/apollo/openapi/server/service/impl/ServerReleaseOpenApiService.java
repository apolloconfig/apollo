...
public class ServerReleaseOpenApiService implements ReleaseOpenApiService {
  ...
  public OpenReleaseDTO publishNamespace(String appId, String env, String clusterName,
    ...
    return OpenApiModelConverters.fromReleaseDTO(releaseService.publish(releaseModel));
  }
  ...
  public OpenReleaseDTO getLatestActiveRelease(String appId, String env, String clusterName,
    ...
    return OpenApiModelConverters.fromReleaseDTO(releaseDTO);
  }
  ...
  public OpenReleaseDTO getReleaseById(String env, long releaseId) {
    ...
    return OpenApiModelConverters.fromReleaseDTO(release);
  }
  ...
  public List<OpenReleaseBO> findAllReleases(String appId, String env, String clusterName, String namespaceName, int page, int size) {
    return OpenApiModelConverters.fromReleaseBOs(releaseService.findAllReleases(appId, Env.valueOf(env), clusterName, namespaceName, page, size));
  }
  ...
  public List<OpenReleaseDTO> findActiveReleases(String appId, String env, String clusterName, String namespaceName, int page, int size) {
    ...
    return releases.stream()
        .map(OpenApiModelConverters::fromReleaseDTO)
