...
public class ItemController {
  ...
  public List<ItemDTO> findBranchItems(
  ...
  @PostMapping(
      value = "/namespaces/{namespaceName}/diff",
      consumes = {"application/json"})
  public List<ItemDiffs> diff(@RequestBody NamespaceSyncModel model) {
    ...
    for (ItemDiffs diff : itemDiffs) {
      ...
      if (permissionValidator.shouldHideConfigToCurrentUser(
          namespace.getAppId(), namespace.getEnv().name(), namespace.getNamespaceName())) {
  ...
  @PutMapping(
      value = "/apps/{appId}/namespaces/{namespaceName}/items",
      consumes = {"application/json"})
      ...
      for (NamespaceIdentifier namespaceIdentifier : model.getSyncToNamespaces()) {
        ...
        hasPermission &=
            permissionValidator.hasModifyNamespacePermission(
                ...
                namespaceIdentifier.getEnv().toString());
        if (!hasPermission) {
  ...
  @PostMapping(
      ...
      consumes = {"application/json"})
  public ResponseEntity<Void> syntaxCheckText(
      @PathVariable String appId,
      @PathVariable String env,
      @PathVariable String clusterName,
      @PathVariable String namespaceName,
