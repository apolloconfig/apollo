...
public class ItemController {
  ...
  public List<ItemDiffs> diff(@PathVariable String namespaceName, @RequestBody NamespaceSyncModel model) {
    ...
    List<ItemDiffs> itemDiffs = configService.compare(namespaceName, model.isIncludeDeletedItems(), model.getSyncToNamespaces(), model.getSyncItems());
  ...
  public ResponseEntity<Void> update(@PathVariable String appId, @PathVariable String namespaceName,
    ...
    if (hasPermission) {
      configService.syncItems(namespaceName, model.isIncludeDeletedItems(), model.getSyncToNamespaces(), model.getSyncItems());
