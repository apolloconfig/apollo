...
public class NamespaceBranchController {
    ...
    public ResponseEntity<OpenGrayReleaseRuleDTO> getBranchGrayRules(@PathVariable String appId,
        ...
        return ResponseEntity.ok(OpenApiModelConverters.fromGrayReleaseRuleDTO(grayReleaseRuleDTO));
    }
    ...
    public ResponseEntity<Void> updateBranchGrayRules(@PathVariable String appId,
        ...
        GrayReleaseRuleDTO grayReleaseRuleDTO = OpenApiModelConverters.toGrayReleaseRuleDTO(rules);
