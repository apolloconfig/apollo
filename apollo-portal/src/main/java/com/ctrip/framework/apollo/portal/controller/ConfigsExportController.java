...
public class ConfigsExportController {
   ...
   */
  @PreAuthorize(
      value = "!@permissionValidator.shouldHideConfigToCurrentUser(#appId, #env, #namespaceName)")
  @GetMapping(
  ...
  public void exportAll(
      @RequestParam(value = "envs") String envs,
    ...
    logger.info(
        "Download configs, remote addr [{}], remote host [{}]. Filename is [{}]",
