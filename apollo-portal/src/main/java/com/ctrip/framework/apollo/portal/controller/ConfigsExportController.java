...
public class ConfigsExportController {
   ...
   */
  @PreAuthorize(
      value = "!@userPermissionValidator.shouldHideConfigToCurrentUser(#appId, #env, #clusterName, #namespaceName)")
  ...
  /**
   * Export all configs in a compressed file. Just export namespace which current exists read
   * permission. The permission check in service.
   */
