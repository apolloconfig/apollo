...
public class EmbeddedApollo extends ExternalResource {
  ...
  private final Map<String, Map<String, String>> addedOrModifiedPropertiesOfNamespace =
          ...
          public MockResponse dispatch(RecordedRequest request) throws InterruptedException {
            if (request.getPath().startsWith("/notifications/v2")) {
              ...
              return new MockResponse()
                  .setResponseCode(200)
                  .setBody(mockLongPollBody(notifications));
            }
  ...
  private String loadConfigFor(String namespace) {
    ...
    ApolloConfig apolloConfig =
        new ApolloConfig("someAppId", "someCluster", namespace, "someReleaseKey");
  ...
  private Map<String, String> mergeOverriddenProperties(
      String namespace, Map<String, String> configurations) {
