...
public class JavaConfigPlaceholderAutoUpdateTest extends AbstractSpringIntegrationTest {
  ...
  public void testAutoUpdateWithOneYamlFile() throws Exception {
    ...
    YamlConfigFile configFile =
        prepareYamlConfigFile(
            "application.yaml", readYamlContentAsConfigFileProperties("case1.yaml"));

    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig12.class);
    ...
    configFile.onRepositoryChange(
        "application.yaml", readYamlContentAsConfigFileProperties("case1-new.yaml"));
  ...
  public void testAutoUpdateWithYamlFileWithValueAndXmlProperty() throws Exception {
    ...
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig13.class);
  ...
  public void testAutoUpdateWithMultipleNamespaces() throws Exception {
    ...
    applicationConfig.onRepositoryChange(
        ConfigConsts.NAMESPACE_APPLICATION, newApplicationProperties);
  ...
  public void testAutoUpdateWithMultipleNamespacesWithSameProperties() throws Exception {
    ...
    Properties fxApolloProperties =
        assembleProperties(
            TIMEOUT_PROPERTY,
            String.valueOf(someTimeout),
            BATCH_PROPERTY,
            String.valueOf(anotherBatch));
    ...
    Properties newFxApolloProperties =
        assembleProperties(
            TIMEOUT_PROPERTY,
            String.valueOf(someNewTimeout),
            BATCH_PROPERTY,
            String.valueOf(someNewBatch));
  ...
  @Test
  public void testAutoUpdateWithMultipleNamespacesWithSamePropertiesWithYamlFile()
      throws Exception {
    int someTimeout = 1000;
    int someBatch = 2000;
    int anotherBatch = 3000;
    ...
    YamlConfigFile configFile =
        prepareYamlConfigFile(
            "application.yml", readYamlContentAsConfigFileProperties("case2.yml"));
    Properties fxApolloProperties =
        assembleProperties(
            TIMEOUT_PROPERTY,
            String.valueOf(someTimeout),
    ...
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig14.class);
    ...
    configFile.onRepositoryChange(
        "application.yml", readYamlContentAsConfigFileProperties("case2-new.yml"));
  ...
  public void testAutoUpdateWithNewPropertiesWithYamlFile() throws Exception {
    ...
    YamlConfigFile configFile =
        prepareYamlConfigFile(
            "application.yaml", readYamlContentAsConfigFileProperties("case3.yaml"));
    ...
    configFile.onRepositoryChange(
        "application.yaml", readYamlContentAsConfigFileProperties("case3-new.yaml"));
  ...
  public void testAutoUpdateWithDeletedPropertiesWithYamlFile() throws Exception {
    ...
    YamlConfigFile configFile =
        prepareYamlConfigFile(
            "application.yaml", readYamlContentAsConfigFileProperties("case4.yaml"));
    ...
    configFile.onRepositoryChange(
        "application.yaml", readYamlContentAsConfigFileProperties("case4-new.yaml"));
  ...
  public void testAutoUpdateWithTypeMismatchWithYamlFile() throws Exception {
    ...
    YamlConfigFile configFile =
        prepareYamlConfigFile(
            "application.yaml", readYamlContentAsConfigFileProperties("case5.yaml"));
    ...
    configFile.onRepositoryChange(
        "application.yaml", readYamlContentAsConfigFileProperties("case5-new.yaml"));
  ...
  public void testApplicationPropertySourceWithValueInjectedInConfiguration() throws Exception {
    ...
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig7.class);
  ...
  public void testAutoUpdateWithNestedProperty() throws Exception {
    ...
    Properties properties =
        assembleProperties(
            ...
            anotherKeyValue,
            String.format("%s.%s", someKeyValue, anotherKeyValue),
            String.valueOf(someValue));

    SimpleConfig config = prepareConfig(ConfigConsts.NAMESPACE_APPLICATION, properties);

    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(NestedPropertyConfig1.class);
    ...
    Properties newProperties =
        assembleProperties(
            ...
            ANOTHER_KEY_PROPERTY,
            anotherKeyValue,
            String.format("%s.%s", newKeyValue, anotherKeyValue),
  ...
  public void testAutoUpdateWithNestedPropertyWithDefaultValue() throws Exception {
    ...
    Properties properties =
        assembleProperties(
            SOME_KEY_PROPERTY, someKeyValue, ANOTHER_KEY_PROPERTY, String.valueOf(someValue));

    SimpleConfig config = prepareConfig(ConfigConsts.NAMESPACE_APPLICATION, properties);

    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(NestedPropertyConfig2.class);

    TestNestedPropertyBeanWithDefaultValue bean =
        context.getBean(TestNestedPropertyBeanWithDefaultValue.class);
  ...
  public void testAutoUpdateWithAllKindsOfDataTypes() throws Exception {
    ...
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig9.class);
  ...
  public void testAutoUpdateJsonValueWithInvalidValue() throws Exception {
    ...
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig10.class);
  ...
  public void testAutoUpdateJsonValueWithNoValueAndDefaultValue() throws Exception {
    ...
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(AppConfig11.class);

    TestApolloJsonValueWithDefaultValue bean =
        context.getBean(TestApolloJsonValueWithDefaultValue.class);
  ...
  static class AppConfig3 {
     ...
     */
    @Bean
    TestJavaConfigBean2 testJavaConfigBean2(
        @Value("${timeout:100}") int timeout, @Value("${batch:200}") int batch) {
