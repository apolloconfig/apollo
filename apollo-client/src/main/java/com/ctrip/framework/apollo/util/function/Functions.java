...
public interface Functions {
  Function<String, Integer> TO_INT_FUNCTION =
  ...
  Function<String, Long> TO_LONG_FUNCTION =
  ...
  Function<String, Short> TO_SHORT_FUNCTION =
  ...
  Function<String, Float> TO_FLOAT_FUNCTION =
  ...
  Function<String, Double> TO_DOUBLE_FUNCTION =
  ...
  Function<String, Byte> TO_BYTE_FUNCTION =
  ...
  Function<String, Boolean> TO_BOOLEAN_FUNCTION =
  ...
  Function<String, Date> TO_DATE_FUNCTION =
  ...
  Function<String, Long> TO_DURATION_FUNCTION =
      new Function<String, Long>() {
        @Override
        public Long apply(String input) {
          try {
