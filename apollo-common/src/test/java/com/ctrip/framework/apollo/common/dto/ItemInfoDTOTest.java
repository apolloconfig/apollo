...
public class ItemInfoDTOTest {
  ...
  @Before
  public void setUp() {
    itemInfoDTO = new ItemInfoDTO("testAppId", "testClusterName", "testNamespaceName", "testKey",
        "testValue");
  }
  ...
  public void testToString_ShouldReturnExpectedString() {
    assertEquals(
        "ItemInfoDTO{appId='testAppId', clusterName='testClusterName', namespaceName='testNamespaceName', key='testKey', value='testValue'}",
        itemInfoDTO.toString());
  }
}
