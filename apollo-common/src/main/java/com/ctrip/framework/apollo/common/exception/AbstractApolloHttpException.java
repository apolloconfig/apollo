...
public abstract class AbstractApolloHttpException extends RuntimeException {
  ...
  /**
   * When args not empty, use
   * {@link com.google.common.base.Strings#lenientFormat(String, Object...)} to replace %s in msgTpl
   * with args to set the error message. Otherwise, use msgTpl to set the error message. e.g.:
   *
   * <pre>
