...
public class AppNamespaceService {
  ...
  public AppNamespace findOne(String appId, String namespaceName) {
    Preconditions.checkArgument(
        !StringUtils.isContainEmpty(appId, namespaceName), "appId or Namespace must not be null");
  ...
  public void createDefaultAppNamespace(String appId, String createBy) {
    ...
    auditService.audit(
        AppNamespace.class.getSimpleName(), appNs.getId(), Audit.OP.INSERT, createBy);
  }
  ...
  public AppNamespace createAppNamespace(AppNamespace appNamespace) {
    ...
    auditService.audit(
        AppNamespace.class.getSimpleName(), appNamespace.getId(), Audit.OP.INSERT, createBy);
    return appNamespace;
  }
  ...
  public AppNamespace update(AppNamespace appNamespace) {
    ...
    auditService.audit(
        AppNamespace.class.getSimpleName(),
        managedNs.getId(),
        Audit.OP.UPDATE,
  ...
  public void deleteAppNamespace(AppNamespace appNamespace, String operator) {
    ...
    logger.info(
        "{} is deleting AppNamespace, appId: {}, namespace: {}", operator, appId, namespaceName);
