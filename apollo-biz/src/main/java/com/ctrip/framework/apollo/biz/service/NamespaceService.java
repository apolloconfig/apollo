...
public class NamespaceService {
  ...
  public Namespace findOne(String appId, String clusterName, String namespaceName) {
    return namespaceRepository.findByAppIdAndClusterNameAndNamespaceName(
  ...
  public Namespace findPublicNamespaceForAssociatedNamespace(
  ...
  public int countPublicAppNamespaceAssociatedNamespaces(String publicNamespaceName) {
    ...
    return namespaceRepository.countByNamespaceNameAndAppIdNot(
        publicNamespaceName, publicAppNamespace.getAppId());
  }
  ...
  public Namespace findChildNamespace(
      String appId, String parentClusterName, String namespaceName) {
  ...
  public Namespace deleteNamespace(Namespace namespace, String operator) {
    ...
    // Child namespace releases should retain as long as the parent namespace exists, because parent
    // namespaces' release
    // histories need them
    if (!isChildNamespace(namespace)) {
    ...
    auditService.audit(
        Namespace.class.getSimpleName(), namespace.getId(), Audit.OP.DELETE, operator);
  ...
  public Namespace update(Namespace namespace) {
    Namespace managedNamespace =
        namespaceRepository.findByAppIdAndClusterNameAndNamespaceName(
