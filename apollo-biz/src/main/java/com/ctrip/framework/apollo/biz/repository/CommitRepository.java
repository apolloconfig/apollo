...
public interface CommitRepository extends PagingAndSortingRepository<Commit, Long> {
  ...
  List<Commit> findByAppIdAndClusterNameAndNamespaceNameAndChangeSetsLikeOrderByIdDesc(
      String appId, String clusterName, String namespaceName, String changeSets, Pageable page);
}
