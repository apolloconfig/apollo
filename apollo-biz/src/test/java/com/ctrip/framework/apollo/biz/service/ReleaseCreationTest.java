...
public class ReleaseCreationTest extends AbstractIntegrationTest {
  ...
  /**
   * Master | Branch ------------------------------ Master | Branch Items k1=v1 |
   * ---------------------------- k2=v2 | k1=v1 | k1=v1 k3=v3 publish master k2=v2 | k2=v2
   * ------------------------------ ===========>> Result k3=v3 | k3=v3 Release | | |
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql",
      executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
  ...
  /**
   * Master | Branch ------------------------------ Master | Branch Items k1=v1 | k1=v1-2
   * ------------------------- k2=v2 | k1=v1 | k1=v1 k3=v3 publish master k2=v2 | k2=v2
   * ------------------------------ ===========>> Result k3=v3 | k3=v3 Release | | |
   */
  @Test
   ...
   * ------------------------------ ===========>> Result k2=v2-2 | k2=v2-2 Release k1=v1 | k1=v1-1 |
   ...
   * ------------------------------ ===========>> Result k2=v2 | k2=v2 Release k1=v1 | k3=v3 | k3=v3
   * k2=v2 | | k4=v4 k3=v3 |
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql",
  ...
  /**
   * Master | Branch ------------------------------ Master | Branch Items k1=v1 | k1=v1-2
   * ---------------------------- k2=v2-2 | k4=v4 k1=v1 | k1=v1-2 k6=v6 publish branch k2=v2 | k2=v2
   * ------------------------------ ===========>> Result k3=v3 | k3=v3 Release k1=v1 | k1=v1-1 |
   * k4=v4 k2=v2 | k2=v2 | k6=v6 k3=v3 | k3=v3 | k4=v4 | k5=v5
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql",
      executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
  ...
  /**
   * Master | Branch ------------------------------ Master | Branch Rollback Release k1=v1 | k1=v1-2
   * ---------------------------- k2=v2 | k2=v2 k1=v1-1 | k1=v1-2 | k3=v3 k2=v2-1 | k2=v2-1 rollback
   * k3=v3 | k3=v3 ------------------------------ ===========>> New Release New Release k1=v1-1 |
   * k2=v2-1 | k3=v3 |
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql",
