...
This document is generated by `scripts/openapi/collect_portal_frontend_urls.py` to track Portal frontend API call migration toward OpenAPI. Delete it after the migration is complete.
